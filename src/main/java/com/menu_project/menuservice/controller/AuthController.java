...
public class AuthController {
    ...
    public ResponseEntity<TokenDto> authorize(@Valid @RequestBody LoginDto loginDto) {
        ...
        UsernamePasswordAuthenticationToken authenticationToken =
                new UsernamePasswordAuthenticationToken(loginDto.getUserPhone(),loginDto.getUserPhone());
        // id, password가 들어가는 자리에 userPhone 정보만 입력
        // UsernamePasswordAuthenticationToken(Object, Object)
